...
public void tasti() {
  ...
  fill(0);
  image(luce,larghezza / 5.5f,altezza / 12,altezza / 4.11f,altezza / 4.11f);  //Simbolo lampadina
  textSize(height / 36);
  text("     LUCI\n INTERNO",larghezza / 4 - altezza / 13.7f,altezza / 4 + altezza / 10);
  image(garage,larghezza / 10 * 6.95f,altezza / 9,height / 4.8f,height / 4.8f);  //Simbolo garage
  fill(0);
  text(" PORTA\nGARAGE",larghezza / 4 * 3 - height / 18.7f,altezza / 4 + height / 10);
  image(luce,larghezza / 5.5f,altezza / 10 * 5.7f,altezza / 4.11f,altezza / 4.11f);  //Simbolo lampadina 2
  textSize(height / 36);
  text("     LUCI\n ESTERNO",larghezza / 4 - height / 13.7f,altezza / 4 * 3 + height / 12);
  //Simbolo cancello
  image(cancello,larghezza / 10 * 6.9f,altezza / 10 * 6.2f,height / 4.5f,height / 5);
  text("CANCELLO",larghezza / 4 * 3 - height / 13.71f,altezza / 4 * 3 + height / 9);
  strokeWeight(1);
}
...
public void luceinterno() {
  ...
  fill(0);
  textSize(height / 57);
  text(" INDIETRO",larghezza / 2 - height / 22.15f,altezza - height / 72);
  textSize(height / 36);
  image(luce,larghezza / 2 - larghezza / 16,altezza / 100,height / 4.8f,height / 4.8f);  //prima lampadina
  text("  LUCE\nCUCINA",larghezza / 2 - width / 31,altezza / 5 + altezza / 20);
  image(luce,larghezza / 2 - larghezza / 16,altezza / 3 + altezza / 100,height / 4.8f,height / 4.8f);  //seconda lampadina
  text("  LUCE\nSALONE",larghezza / 2 - width / 31,altezza / 5 * 2.7f + altezza / 20);
  image(luce,larghezza / 2 - larghezza / 16,altezza - altezza / 3 + altezza / 100,height / 4.8f,height / 4.8f);  //terza lampadina
  text("   LUCE\n GARAGE",larghezza / 2 - width / 28,altezza / 5 * 4.3f + altezza / 20);
  strokeWeight(1);
}
...
public void portagarage() {
  ...
  image(garage,larghezza / 2 - altezza / 9.6f,altezza / 2 - altezza / 6,height / 4.8f,height / 4.8f);
  fill(130);
  rect(0,altezza - (altezza / 25),larghezza,altezza / 25);
  fill(0);
  textSize(height / 57);
...
public void luciesterno() {
  ...
  image(luce,larghezza / 5.5f,altezza / 10 * 3.3f,altezza / 4.11f,altezza / 4.11f);  //Lampadina
  fill(0);
  textSize(height / 36);
  text("   LUCE\nESTERNO",larghezza / 4 - height / 17.1f,altezza / 5 * 3);
  text("AUTOMAZIONE",larghezza / 4 * 3 - height / 17.1f,altezza / 5 * 3);
...
public void cancello() {
  ...
  textSize(height / 57);
  text(" INDIETRO",larghezza / 2 - height / 22.15f,altezza - height / 72);
  image(cancello,larghezza / 2 - height / 9,altezza / 2 - height / 6,height / 4.5f,height / 5);
  textSize(height / 36);
  text("CANCELLO",larghezza / 2 - height / 13.71f,altezza / 2 + height / 12);
  strokeWeight(1);
}
...
public void tasti2() {
  ...
  strokeWeight(1);
  image(scena,larghezza / 6.5f,altezza / 4,height / 3.5f,height / 3.5f);
  fill(0);
  textSize(height / 20);
  text("SCENE",larghezza / 5.3f,altezza / 10 * 7);
  image(termometro,larghezza / 10 * 6.5f,altezza / 4,height / 3.5f,height / 3.5f);
  text("TEMPERATURA",larghezza / 10 * 6.5f,altezza / 10 * 7);
}
